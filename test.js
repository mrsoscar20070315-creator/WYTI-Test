...
(function() {
  ...
  const DIMENSION_LABELS = {
    ...
    D: { name: "逻辑分析力", icon: "💻", color: "#38bdf8" },
    P: { name: "理论推导力", icon: "⚛️", color: "#7dd3fc" },
    S: { name: "系统整合力", icon: "🌐", color: "#0369a1" },
  ...
  const questions = [
    ...
    {
      id: 5,
      text: "如果有一门课的作业可以在以下四个方案中选择，你会选：",
      options: [
        { text: "动手做一个有趣的小东西（立体海报、翻页书），做出来就给A+", scores: { M: 2, S: 1 } },
        { text: "老样子，写一份有关课程主题的报告，但是内容要求很高", scores: { D: 2, P: 1 } },
        { text: "整理一些有关身边事物的思考/随笔，需要体现出自己的思考", scores: { S: 2, P: 1 } },
        { text: "提一些关于课程内容以及框架的建议，要求有建设性", scores: { V: 2, M: 1 } }
      ]
    },
    {
      id: 6,
      text: "做实验时，你主要考虑的是：",
      options: [
        { text: "不管了，直接开做，边整理数据边写", scores: { M: 2, D: 1 } },
        { text: "明确实验的每个步骤，一步步来", scores: { D: 2, S: 1 } },
        { text: "先把原理和推导部分写好才知道实验咋做", scores: { P: 2, D: 1 } },
        { text: "老师能不能看懂，写的好看一点", scores: { V: 2, S: 1 } }
      ]
    },
    {
      id: 7,
      text: "给你一个月的时间，除了宅在宿舍里打游戏，你更希望：",
      options: [
    ...
    },
    {
      ...
      text: "小组作业有人进度落后，你会：",
      options: [
        { text: "直接上手帮他完成那部分", scores: { M: 2, V: 1 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "不断探索，做没人做过的前沿", scores: { P: 2, S: 1 } },
        { text: "协调一个团队实现一个伟大的项目", scores: { S: 2, V: 1 } },
        { text: "不管做什么，能让更多的人能从我的工作中受益", scores: { V: 2, P: 1 } }
      ]
    },
    {
      id: 12,
    ...
    },
    {
      ...
      text: "五年后你最期待自己能：",
      options: [
        { text: "带领一个完整的项目", scores: { M: 2, S: 1 } },
        { text: "在某个领域有扎实积累", scores: { P: 2, D: 1 } },
        { text: "在不同领域做出新东西", scores: { S: 2, P: 1 } },
        { text: "有几个十分要好，互相鼓励的朋友", scores: { V: 2, P: 1 } }
      ]
    },
    {
      id: 16,
    ...
    },
    {
      ...
      options: [
        ...
        { text: "讲课推理严密、层层递进", scores: { D: 2, P: 1 } },
        { text: "能发散思维，把之前的知识串起来", scores: { S: 2, P: 1 } },
        { text: "让学生学完这门课后充满获得感", scores: { V: 2, M: 1 } }
      ]
    },
    {
      id: 18,
    ...
    },
    {
      ...
      text: "听说一个很火的梗，你会？",
      options: [
        { text: "新梗？先玩为敬", scores: { M: 2, S: 1 } },
        { text: "先看看大家都怎么玩这个梗", scores: { D: 2, P: 1 } },
        { text: "先搜来源搞清楚", scores: { P: 2, M: 1 } },
        { text: "谨慎思考这个梗的广泛影响（我玩这个会不会不太好）", scores: { V: 2, D: 1 } }
      ]
    },
    {
      id: 20,
      text: "和陌生人聊天，更容易聊到？",
      options: [
        { text: "负责具体的实现和执行", scores: { M: 2, D: 1 } },
        { text: "分析任务结构并分配工作", scores: { S: 2, D: 1 } },
        { text: "解决团队遇到的技术难题", scores: { P: 2, D: 1 } },
        { text: "协调大家的关系和沟通", scores: { V: 2, S: 1 } }
      ]
    },
    {
      id: 21,
      ...
      options: [
        ...
        { text: "整了一个超级无敌好活", scores: { S: 2, P: 1 } },
    ...
    },
    {
      ...
      text: "和陌生人聊天，更容易聊到？",
      options: [
        { text: "最近手头上的事情", scores: { M: 2, P: 1 } },
        { text: "技术/游戏/设备", scores: { D: 2, S: 1 } },
        { text: "梦到哪句说哪句，反正大脑会把逻辑补上", scores: { P: 2, S: 1 } },
        { text: "社会热点/公共议题", scores: { V: 2, M: 1 } }
      ]
    },
    {
      id: 24,
